...
window.onload = () => { 
  ...
  new TabsManager(tabsElem); 
    ...
    $('.slider').slick({
      // prevArrow:"<img class='a-left control-c prev slick-prev' src='../images/arrowLeft.svg'>",
      // nextArrow:"<img class='a-right control-c next slick-next' src='../images/arrowRight.svg'>",
